...
public class AuthGlobalFilter implements GlobalFilter, Ordered {
	 ...
	 * 不需要认证的路径
	 */
	private static final List<String> WHITE_LIST = Arrays.asList("/auth/**", "/actuator/**");
	...
	private Mono<Void> unauthorizedResponse(ServerWebExchange exchange) {
		...
		return WebFluxResponseUtil.writeJson(response, HttpStatus.UNAUTHORIZED, result, objectMapper);
	}
