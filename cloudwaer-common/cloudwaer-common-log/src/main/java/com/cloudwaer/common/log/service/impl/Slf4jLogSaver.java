...
public class Slf4jLogSaver implements LogSaver {
	...
	public void save(LogRecord r) {
		...
		log.info(
				"REQ_LOG | time={} | service={} | ip={} | method={} | uri={} | class={} | func={} | success={} |  | err={}",
				r.getTimestamp(), r.getService(), r.getIp(), r.getHttpMethod(), r.getUri(), r.getClassName(),
				r.getMethodName(), r.isSuccess(), safe(r.getError()));
	}
