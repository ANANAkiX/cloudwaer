...
/**
 * 请求日志组件配置 配置前缀：cloudwaer.log
 * <p>
 * 示例： cloudwaer: log: enabled: true exclude-paths: - /actuator/** - /auth/captcha
 * exclude-http-methods: - OPTIONS exclude-class-names: -
 * com.cloudwaer.demo.IgnoreController exclude-method-names: - ping
 */
