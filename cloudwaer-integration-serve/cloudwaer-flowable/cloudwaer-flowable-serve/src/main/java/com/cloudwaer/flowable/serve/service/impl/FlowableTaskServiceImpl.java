...
public class FlowableTaskServiceImpl implements FlowableTaskService {
	...
	public PageResult<FlowableTaskDTO> listTodo(PageDTO pageDTO) {
		...
		for (Task task : list) {
			...
			dto.setProcessDefinitionName(resolveProcessDisplayName(task.getProcessInstanceId(),
					resolveProcessDefinitionName(task.getProcessDefinitionId())));
	...
	public FlowableTaskDTO getDetail(String taskId) {
		...
		dto.setProcessDefinitionName(resolveProcessDisplayName(historic.getProcessInstanceId(),
				resolveProcessDefinitionName(historic.getProcessDefinitionId())));
	...
	public boolean deleteTask(String taskId) {
		...
		taskExtMapper.delete(new LambdaQueryWrapper<WfTaskExt>().eq(WfTaskExt::getTaskId, taskId));
		return true;
	}
