...
public class MetadataServiceImpl implements MetadataService {
    ...
    private TableMetadataDTO getTableMetadata(Connection connection, String tableName) throws SQLException {
        ...
        // 按顺序排序
        columns.sort((a, b) -> {
            if (a.getOrdinalPosition() == null) return 1;
            if (b.getOrdinalPosition() == null) return -1;
    ...
    private String mapToJavaType(String typeName, int sqlType) {
        ...
        if (upperTypeName.contains("VARCHAR") || upperTypeName.contains("CHAR") ||
                upperTypeName.contains("TEXT") || upperTypeName.contains("CLOB")) {
            return "String";
            ...
            return "Double";
        } else if (upperTypeName.contains("DATE") || upperTypeName.contains("TIME") || upperTypeName.contains("TIMESTAMP")) {
            return "java.time.LocalDateTime";
        } else if (upperTypeName.contains("BOOLEAN") || upperTypeName.contains("BIT") && !upperTypeName.contains("VARBINARY")) {
            return "Boolean";
